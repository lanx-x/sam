...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    advantages: Schema.Attribute.Component<'section.basic-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    capabilities: Schema.Attribute.Component<'section.basic-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    detailPageBanner: Schema.Attribute.Media<
    ...
    detailPageDesc: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEquipmentCategoryEquipmentCategory
  ...
  attributes: {
    ...
    isAll: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    case_study: Schema.Attribute.Component<'section.basic-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    challenges: Schema.Attribute.Component<'section.basic-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    detailPageDesc: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    detailPageFeatures: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    molding_capabilities: Schema.Attribute.Component<
    ...
    publishedAt: Schema.Attribute.DateTime;
    tooling_capabilities: Schema.Attribute.Component<
      'section.basic-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relevant_drawings: Schema.Attribute.Media<'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMaterialMaterial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Relation<
      ...
      'api::material-category.material-category'
    >;
    cons: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    value: Schema.Attribute.Component<'item.nav-groupt-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<['section.common-section']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRendererRenderer extends Struct.CollectionTypeSchema {
...
export interface ApiSiteSite extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    email: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    fax: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    mobile: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    tel: Schema.Attribute.Component<'item.kv-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSurfaceTreatmentSurfaceTreatment
  ...
  info: {
    ...
    pluralName: 'surface-treatments';
    singularName: 'surface-treatment';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    external: Schema.Attribute.JSON &
    ...
    internal: Schema.Attribute.Component<'item.video-item', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
