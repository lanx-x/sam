...
export function Comment() {
  ...
  return (
    <Section
      title="Solution Service Customer system quality Smart experience expert experience System"
      desc="Efficient global development management success efficient Experience System sustainable development digital Advanced Success factory Platform Development reliable leader growth platform"
      bg={Assets.Map}
