  ...
  return (
    <div className="relative text-center pt-10 pb-15 xl:pt-20 xl:pb-27.25">
      ...
      <div className="relative z-10">
        <h2 className="px-5 section-title">Dolor facere nulla voluptatem eaque nulla nam aut. Ducimus mollitia!</h2>
        <p className="px-5 mb-18.5 section-desc xl:mb-25">Lorem architecto quod aperiam iste dignissimos Commodi repellat explicabo quisquam!</p>
      </div>
