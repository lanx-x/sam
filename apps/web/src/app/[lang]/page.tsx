...
function Stats({ stats }: { stats?: StatItemData[] }) {
...
function Cap({ cap }: { cap?: CapSectionData }) {
  ...
  return (
    <div className="text-center px-5 bt mt-15 mb-10 xl:mb-18.25">
      <h2 className="font-semibold text-[32px] mb-2 xl:text-5xl">{title}</h2>
      <p className="mb-10 xl:text-base">{desc}</p>
...
export default async function Home({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div>
      ...
      <Stats stats={homeData?.stats ?? undefined} />
